...
export const Logo = () => {
  return (
    <div className="relative z-20 flex items-center space-x-2 py-1 text-sm font-normal text-black">
      <Image
        src="https://cdn.discordapp.com/attachments/1205078015319613452/1376247052140286173/paws2.jpg?ex=68354a32&is=6833f8b2&hm=268e1fd9389ea5cb613d2a3b84196460296099c9abf6c0724620d53cfe656534&"
        width={24}
        height={24}
        alt="logo"
