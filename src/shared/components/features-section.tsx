  ...
  const features = [
    {
      ...
      description:
        'Track and manage your pet issues with ease using our intuitive interface.',
      skeleton: <SkeletonOne />,
      className:
        'col-span-1 lg:col-span-4 border-b lg:border-r dark:border-neutral-800',
    },
    {
      title: 'Capture habitat with AI',
      description:
    ...
    },
    {
      ...
      description:
        'With our blazing fast, state of the art, cutting edge, we are so back courier - you can buy your item in seconds.',
    ...
    <div className="relative z-20 py-10 lg:py-40 mx-auto">
      <div className="px-8">
        ...
        <p className="text-sm lg:text-base  max-w-2xl  my-4 mx-auto text-neutral-500 text-center font-normal dark:text-neutral-300">
          From Imagination to realization, Everything pet has feel for literally
...
const FeatureCard = ({
  ...
  return (
    <div
      className={cn(
        'p-4 sm:p-8 relative overflow-hidden max-h-[650px]',
        className,
      )}
    >
      {children}
...
export const SkeletonThree = () => {
  return (
    <a
      href="https://www.youtube.com/watch?v=biro7b-xhLQ"
      target="__blank"
